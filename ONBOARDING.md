...
1. **[Setup your environment](#environment-setup)** (5 min)
2. **[Understand the project](#project-architecture-overview)** (10 min)
3. **[Run tests locally](#testing)** (5 min)
4. **[Make your first contribution](#your-first-contribution)** (10 min)
